...
class AttributeController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['validations'] = Attribute::validation();
    }
    /**
    ...
    public function store(AttributeRequest $request)
    {
        ...
        if (Attribute::create($params)){
            ...
            Session::flash('success', 'Attribute could not be saved');
        }
    ...
    public function update(AttributeRequest $request, $id)
    {
        ...
        if($attribute->update($params)){
            ...
            Session::flash('error', 'Attribute could not be saved');
        }
    ...
    public function destroy($id)
    {
        ...
        if($attribute->delete()){
            ...
            Session::flash('error', 'Attribute could not be deleted');
        }
    ...
    public function remove_option($optionID)
    {
        ...
        if($option->delete()){
            ...
            Session::flash('error', 'Option could not be deleted');
        }
