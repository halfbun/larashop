...
class ProductController extends Controller
{
    ...
    private function generateAttributeCombination($arrays)
    {
        $result = [[]];
    ...
    private function generateProductVariants($product, $params)
    {
        ...
        $variants = $this->generateAttributeCombination($variantAttributes);
    ...
    public function remove_image($id)
    {
        ...
        if($image->delete()){
            ...
            Session::flash('error' , 'image could not be deleted');
        }
